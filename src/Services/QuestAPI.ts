...
export class QuestAPI 
{
    ...
    /*public loadQuestsRepeatableTemplateFromDisk(): void
    {
        ...
        this.instanceManager.database.templates.repeatableQuests = jsonData;
        if (this.instanceManager.debug)
        {
            console.log(this.instanceManager.database.templates.repeatableQuests);
        }
        this.instanceManager.logger.log(`[${this.instanceManager.modName}] QuestAPI: Loaded repeatableQuests.json`, LogTextColor.GREEN);
    } */
